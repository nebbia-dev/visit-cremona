...
export default async function Cycling() {
    ...
    const pages = await getExperiences('/it/discover/cycling');
    ...
    const dataEvents = await getEvents('/it/discover/cycling', {tag: '4'});
    ...
    return (
        <>
            <section className="mt-[79px] fadein-slower">
                ...
                <div
                    ...
                    <div className="flex w-full items-end md:w-2/4">
                        <VideoPlayer
                            title="Video di presentazione del progetto Tales of Cycling"
            ...
            <section className="w-[95vw] md:w-[80vw] mx-auto items-center justify-center px-4 md:px-8 pt-8 pb-24">
                <ConsentIframe
                    title="Mappa del percorso Infinito Viaggiare"
