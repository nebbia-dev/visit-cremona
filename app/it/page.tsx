...
export default async function Home() {
    ...
    const pages = await getExperiences('/it');
    ...
    const dataEvents = await getEvents('/it');
          ...
          <section
              ...
              <div className="flex flex-col gap-2 md:w-2/4 w-full">
                  ...
                  <div className="w-full text-right mt-8">
                      <Link href="/it/discover" className="font-bold underline relative">
              ...
              <div className="w-full h-[400px] md:w-2/4 md:h-auto relative">
                  {content.data['sub_hero_image']
                      ...
                      : content.data['sub_hero_video']
                          ? <VideoPlayer
                              src={content.data['sub_hero_video']}
                              title="Video di presentazione del progetto Tales of Harmonies"
          ...
          <section className="w-full bg-pastel-pink">
              <div
                  ...
                  <div className="w-full text-right">
                      <Link href="/it/experiences/unique" className="font-bold underline relative">
              ...
              <section className="w-full">
                  <div
                      ...
                      <div className="w-full text-right mt-4">
                          <Link href="/it/events" className="font-bold underline relative">
