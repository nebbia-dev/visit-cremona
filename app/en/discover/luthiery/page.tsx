...
export default async function Luthiery() {
    ...
    const pages = await getExperiences('/en/discover/luthiery', { locale: 'en' });
    ...
    const dataEvents = await getEvents('/en/discover/luthiery', {
        lang: 'en',
        tag: '12',
    });
            ...
            <section className="mt-[79px] fadein-slower">
                ...
                <div
                    ...
                    <div id="luthieryVideo" className="flex w-full items-end md:w-2/4">
                        <VideoPlayer
                            title="Tales of Luthiery presentation video"
