...
export default async function Stories() {
    ...
    try {
        let data = await fetch(process.env.NEXT_PUBLIC_BASE_URL + '/api/stories?populate=*&locale=en',
    ...
    return(
        <section className="mt-[79px] fadein-slower">
            <div className="w-[95vw] md:w-[80vw] mx-auto items-center justify-center px-4 md:px-8 pt-20 pb-24">
                <p className="text-sm"><span className="font-semibold"><Link href="/en">Home</Link> / </span> Stories</p>
