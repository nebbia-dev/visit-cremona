...
export default async function ContemporaryExperiences() {
    ...
    const pages = await getExperiences('/en/experiences/contemporary', { locale: 'en' });
            ...
            <section className="mt-[79px] fadein-slower">
                <div
                    ...
                    <div className="flex flex-col gap-4 w-full">
                        <p className="text-sm"><span className="font-semibold"><Link href="/en">Home</Link> / <Link href="/en/experiences">Experiences</Link> /</span> Contemporary</p>
